...
pub mod CBCMR {
    ...
    pub mod LPSPI_PODF {
        ...
        pub mod RW {
            ...
            /// 0b0000: divide by 1
            pub const LPSPI_PODF_0: u32 = 0b0000;

            /// 0b0001: divide by 2
            pub const LPSPI_PODF_1: u32 = 0b0001;

            /// 0b0010: divide by 3
            pub const LPSPI_PODF_2: u32 = 0b0010;

            /// 0b0011: divide by 4
            pub const LPSPI_PODF_3: u32 = 0b0011;

            /// 0b0100: divide by 5
            pub const LPSPI_PODF_4: u32 = 0b0100;

            /// 0b0101: divide by 6
            pub const LPSPI_PODF_5: u32 = 0b0101;

            /// 0b0110: divide by 7
            pub const LPSPI_PODF_6: u32 = 0b0110;

            /// 0b0111: divide by 8
            pub const LPSPI_PODF_7: u32 = 0b0111;

            /// 0b1000: divide by 9
            pub const LPSPI_PODF_8: u32 = 0b1000;

            /// 0b1001: divide by 10
            pub const LPSPI_PODF_9: u32 = 0b1001;

            /// 0b1010: divide by 11
            pub const LPSPI_PODF_10: u32 = 0b1010;

            /// 0b1011: divide by 12
            pub const LPSPI_PODF_11: u32 = 0b1011;

            /// 0b1100: divide by 13
            pub const LPSPI_PODF_12: u32 = 0b1100;

            /// 0b1101: divide by 14
            pub const LPSPI_PODF_13: u32 = 0b1101;

            /// 0b1110: divide by 15
            pub const LPSPI_PODF_14: u32 = 0b1110;

            /// 0b1111: divide by 16
            pub const LPSPI_PODF_15: u32 = 0b1111;
        }
    }
}
...
pub mod CSCMR1 {
    ...
    pub mod FLEXSPI_CLK_SRC {
        ...
        pub mod RW {
            ...
            pub const FLEXSPI_CLK_SRC_0: u32 = 0b0;

            /// 0b1: derive clock selected by CCM_CBCMR\[PERIPH_CLK2_ SEL\]
            pub const FLEXSPI_CLK_SRC_1: u32 = 0b1;
        }
    }
}
...
pub mod CSCMR2 {
    ...
    pub mod ADC_ACLK_PODF {
        ...
        pub mod RW {
            ...
            pub const ADC_ACLK_PODF_7: u32 = 0b0111;

            /// 0b1011: pll3_sw_clk / 12
            pub const ADC_ACLK_PODF_11: u32 = 0b1011;

            /// 0b1111: pll3_sw_clk / 16
            pub const ADC_ACLK_PODF_15: u32 = 0b1111;
        }
    }
    ...
    pub mod ADC_ACLK_EN {
        ...
        pub mod RW {
            ...
            pub const ADC_ACLK_EN_0: u32 = 0b0;

            /// 0b1: ADC alt_clk source is enabled
            pub const ADC_ACLK_EN_1: u32 = 0b1;
        }
    }
}
...
pub mod CSCDR1 {
    ...
    pub mod UART_CLK_SEL {
        ...
        pub mod RW {
            ...
            pub const UART_CLK_SEL_0: u32 = 0b00;

            /// 0b01: derive clock from osc_clk
            pub const UART_CLK_SEL_1: u32 = 0b01;

            /// 0b10: derive clock from per_clk_root
            pub const UART_CLK_SEL_2: u32 = 0b10;
        }
    }
    ...
    pub mod TRACE_PODF {
        ...
        pub mod RW {
            ...
            /// 0b0000: divide by 1
            pub const TRACE_PODF_0: u32 = 0b0000;

            /// 0b0001: divide by 2
            pub const TRACE_PODF_1: u32 = 0b0001;

            /// 0b0010: divide by 3
            pub const TRACE_PODF_2: u32 = 0b0010;

            /// 0b0011: divide by 4
            pub const TRACE_PODF_3: u32 = 0b0011;

            /// 0b0100: divide by 5
            pub const TRACE_PODF_4: u32 = 0b0100;

            /// 0b0101: divide by 6
            pub const TRACE_PODF_5: u32 = 0b0101;

            /// 0b0110: divide by 7
            pub const TRACE_PODF_6: u32 = 0b0110;

            /// 0b0111: divide by 8
            pub const TRACE_PODF_7: u32 = 0b0111;

            /// 0b1000: divide by 9
            pub const TRACE_PODF_8: u32 = 0b1000;

            /// 0b1001: divide by 10
            pub const TRACE_PODF_9: u32 = 0b1001;

            /// 0b1010: divide by 11
            pub const TRACE_PODF_10: u32 = 0b1010;

            /// 0b1011: divide by 12
            pub const TRACE_PODF_11: u32 = 0b1011;

            /// 0b1100: divide by 13
            pub const TRACE_PODF_12: u32 = 0b1100;

            /// 0b1101: divide by 14
            pub const TRACE_PODF_13: u32 = 0b1101;

            /// 0b1110: divide by 15
            pub const TRACE_PODF_14: u32 = 0b1110;

            /// 0b1111: divide by 16
            pub const TRACE_PODF_15: u32 = 0b1111;
        }
    }
}
...
pub mod CS1CDR {
    ...
    pub mod FLEXIO1_CLK_PRED {
        ...
        pub mod RW {
            ...
            /// 0b000: divide by 1
            pub const FLEXIO1_CLK_PRED_0: u32 = 0b000;

            /// 0b001: divide by 2
            pub const FLEXIO1_CLK_PRED_1: u32 = 0b001;

            /// 0b010: divide by 3
            pub const FLEXIO1_CLK_PRED_2: u32 = 0b010;

            /// 0b011: divide by 4
            pub const FLEXIO1_CLK_PRED_3: u32 = 0b011;

            /// 0b100: divide by 5
            pub const FLEXIO1_CLK_PRED_4: u32 = 0b100;

            /// 0b101: divide by 6
            pub const FLEXIO1_CLK_PRED_5: u32 = 0b101;

            /// 0b110: divide by 7
            pub const FLEXIO1_CLK_PRED_6: u32 = 0b110;

            /// 0b111: divide by 8
            pub const FLEXIO1_CLK_PRED_7: u32 = 0b111;
        }
    }
    ...
    pub mod FLEXIO1_CLK_PODF {
        ...
        pub mod RW {
            ...
            /// 0b0000: Divide by 1
            pub const DIVIDE_1: u32 = 0b0000;

            /// 0b0001: Divide by 2
            pub const DIVIDE_2: u32 = 0b0001;

            /// 0b0010: Divide by 3
            pub const DIVIDE_3: u32 = 0b0010;

            /// 0b0011: Divide by 4
            pub const DIVIDE_4: u32 = 0b0011;

            /// 0b0100: Divide by 5
            pub const DIVIDE_5: u32 = 0b0100;

            /// 0b0101: Divide by 6
            pub const DIVIDE_6: u32 = 0b0101;

            /// 0b0110: Divide by 7
            pub const DIVIDE_7: u32 = 0b0110;

            /// 0b0111: Divide by 8
            pub const DIVIDE_8: u32 = 0b0111;

            /// 0b1000: Divide by 9
            pub const DIVIDE_9: u32 = 0b1000;

            /// 0b1001: Divide by 10
            pub const DIVIDE_10: u32 = 0b1001;

            /// 0b1010: Divide by 11
            pub const DIVIDE_11: u32 = 0b1010;

            /// 0b1011: Divide by 12
            pub const DIVIDE_12: u32 = 0b1011;

            /// 0b1100: Divide by 13
            pub const DIVIDE_13: u32 = 0b1100;

            /// 0b1101: Divide by 14
            pub const DIVIDE_14: u32 = 0b1101;

            /// 0b1110: Divide by 15
            pub const DIVIDE_15: u32 = 0b1110;

            /// 0b1111: Divide by 16
            pub const DIVIDE_16: u32 = 0b1111;
        }
    }
}
...
pub mod CDCDR {
    ...
    pub mod SPDIF0_CLK_PRED {
        ...
        /// Write-only values (empty)
        pub mod W {}
        pub use super::SPDIF0_CLK_PODF::RW;
    }
}
...
pub mod CDHIPR {
    ...
    pub mod FLEXSPI_PODF_BUSY {
        ...
        pub mod RW {
            ...
            /// 0b0: divider is not busy and its value represents the actual division.
            pub const FLEXSPI_PODF_BUSY_0: u32 = 0b0;

            /// 0b1: divider is busy with handshake process with module. The value read in the divider represents the previous value of the division factor, and after the handshake the written value of the flexspi_podf will be applied.
            pub const FLEXSPI_PODF_BUSY_1: u32 = 0b1;
        }
    }

    /// Busy indicator for perclk_podf.
    pub mod PERCLK_PODF_BUSY {
        /// Offset (4 bits)
        pub const offset: u32 = 4;
        /// Mask (1 bit: 1 << 4)
        pub const mask: u32 = 1 << offset;
        ...
        pub mod RW {
            ...
            /// 0b0: divider is not busy and its value represents the actual division.
            pub const PERCLK_PODF_BUSY_0: u32 = 0b0;

            /// 0b1: divider is busy with handshake process with module. The value read in the divider represents the previous value of the division factor, and after the handshake the written value of the perclk_podf will be applied.
            pub const PERCLK_PODF_BUSY_1: u32 = 0b1;
        }
    }
...
pub mod CISR {
    ...
    /// CCM interrupt request 1 generated due to frequency change of flexspi_podf
    pub mod FLEXSPI_PODF_LOADED {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
        pub const mask: u32 = 1 << offset;
        ...
        pub mod RW {
            ...
            pub const FLEXSPI_PODF_LOADED_0: u32 = 0b0;

            /// 0b1: interrupt generated due to frequency change of flexspi_podf
            pub const FLEXSPI_PODF_LOADED_1: u32 = 0b1;
        }
    }

    /// CCM interrupt request 1 generated due to frequency change of perclk_podf
    pub mod PERCLK_PODF_LOADED {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
        pub const mask: u32 = 1 << offset;
        ...
        pub mod RW {
            ...
            pub const PERCLK_PODF_LOADED_0: u32 = 0b0;

            /// 0b1: interrupt generated due to frequency change of perclk_podf
            pub const PERCLK_PODF_LOADED_1: u32 = 0b1;
        }
    }
...
pub mod CIMR {
    ...
    pub mod MASK_FLEXSPI_PODF_LOADED {
        /// Offset (16 bits)
        pub const offset: u32 = 16;
        /// Mask (1 bit: 1 << 16)
        pub const mask: u32 = 1 << offset;
        ...
        pub mod RW {
            ...
            pub const MASK_FLEXSPI_PODF_LOADED_0: u32 = 0b0;

            /// 0b1: mask interrupt due to update of flexspi_podf
            pub const MASK_FLEXSPI_PODF_LOADED_1: u32 = 0b1;
        }
    }

    /// mask interrupt generation due to update of perclk_podf
    pub mod MASK_PERCLK_PODF_LOADED {
        /// Offset (18 bits)
        pub const offset: u32 = 18;
        /// Mask (1 bit: 1 << 18)
        pub const mask: u32 = 1 << offset;
        ...
        pub mod RW {
            ...
            pub const MASK_PERCLK_PODF_LOADED_0: u32 = 0b0;

            /// 0b1: mask interrupt due to update of perclk_podf
            pub const MASK_PERCLK_PODF_LOADED_1: u32 = 0b1;
        }
    }
...
pub mod CCOSR {
    ...
    pub mod CLKO1_SEL {
        ...
        pub mod RW {
            ...
            pub const CLKO1_SEL_2: u32 = 0b0010;
    ...
    pub mod CLKO2_SEL {
        ...
        pub mod RW {
            ...
            pub const CLKO2_SEL_16: u32 = 0b10000;
            ...
            pub const CLKO2_SEL_22: u32 = 0b10110;
