...
pub mod SCR {
    ...
    pub mod lockup_rst {
        ...
        pub mod RW {
            ...
            /// 0b0: disabled
            pub const lockup_rst_0: u32 = 0b0;

            /// 0b1: enabled
            pub const lockup_rst_1: u32 = 0b1;
        }
    }
...
pub mod SRSR {
    ...
    pub mod lockup {
        ...
        pub mod RW {
            ...
            pub const lockup_0: u32 = 0b0;

            /// 0b1: Reset is a result of the mentioned case.
            pub const lockup_1: u32 = 0b1;
        }
    }
    ...
    pub mod jtag_sw_rst {
        ...
        pub mod RW {
            ...
            /// 0b1: Reset is not a result of the mentioned case.
