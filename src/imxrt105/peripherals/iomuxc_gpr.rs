...
pub mod GPR1 {
    ...
    /// Global interrupt bit (connected to ARM M7 IRQ#41 and GPC)
    pub mod GINT {
        /// Offset (12 bits)
    ...
    /// ENET1_TX_CLK data direction control when ENET_REF_CLK1 ALT is selected.
...
pub mod GPR2 {
    ...
    /// enable power saving features on memory
...
pub mod GPR3 {
    ...
    pub mod OCRAM_STATUS {
        ...
        pub mod RW {
            ...
            pub const OCRAM_STATUS_0: u32 = 0b0000;

            /// 0b0001: read data pipeline control bit changed
            pub const OCRAM_STATUS_1: u32 = 0b0001;
        }
    }
}
