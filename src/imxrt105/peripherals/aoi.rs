...
pub mod BFCRT010 {
    ...
    pub mod PT0_DC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the D input in this product term to a logical zero
            pub const PT0_DC_0: u16 = 0b00;

            /// 0b01: Pass the D input in this product term
            pub const PT0_DC_1: u16 = 0b01;

            /// 0b10: Complement the D input in this product term
            pub const PT0_DC_2: u16 = 0b10;

            /// 0b11: Force the D input in this product term to a logical one
            pub const PT0_DC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT0_CC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the C input in this product term to a logical zero
            pub const PT0_CC_0: u16 = 0b00;

            /// 0b01: Pass the C input in this product term
            pub const PT0_CC_1: u16 = 0b01;

            /// 0b10: Complement the C input in this product term
            pub const PT0_CC_2: u16 = 0b10;

            /// 0b11: Force the C input in this product term to a logical one
            pub const PT0_CC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT0_BC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the B input in this product term to a logical zero
            pub const PT0_BC_0: u16 = 0b00;

            /// 0b01: Pass the B input in this product term
            pub const PT0_BC_1: u16 = 0b01;

            /// 0b10: Complement the B input in this product term
            pub const PT0_BC_2: u16 = 0b10;

            /// 0b11: Force the B input in this product term to a logical one
            pub const PT0_BC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT0_AC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the A input in this product term to a logical zero
            pub const PT0_AC_0: u16 = 0b00;

            /// 0b01: Pass the A input in this product term
            pub const PT0_AC_1: u16 = 0b01;

            /// 0b10: Complement the A input in this product term
            pub const PT0_AC_2: u16 = 0b10;

            /// 0b11: Force the A input in this product term to a logical one
            pub const PT0_AC_3: u16 = 0b11;
        }
    }
}
...
pub mod BFCRT230 {
    ...
    pub mod PT3_DC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the D input in this product term to a logical zero
            pub const PT3_DC_0: u16 = 0b00;

            /// 0b01: Pass the D input in this product term
            pub const PT3_DC_1: u16 = 0b01;

            /// 0b10: Complement the D input in this product term
            pub const PT3_DC_2: u16 = 0b10;

            /// 0b11: Force the D input in this product term to a logical one
            pub const PT3_DC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT3_CC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the C input in this product term to a logical zero
            pub const PT3_CC_0: u16 = 0b00;

            /// 0b01: Pass the C input in this product term
            pub const PT3_CC_1: u16 = 0b01;

            /// 0b10: Complement the C input in this product term
            pub const PT3_CC_2: u16 = 0b10;

            /// 0b11: Force the C input in this product term to a logical one
            pub const PT3_CC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT3_BC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the B input in this product term to a logical zero
            pub const PT3_BC_0: u16 = 0b00;

            /// 0b01: Pass the B input in this product term
            pub const PT3_BC_1: u16 = 0b01;

            /// 0b10: Complement the B input in this product term
            pub const PT3_BC_2: u16 = 0b10;

            /// 0b11: Force the B input in this product term to a logical one
            pub const PT3_BC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT3_AC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the A input in this product term to a logical zero
            pub const PT3_AC_0: u16 = 0b00;

            /// 0b01: Pass the A input in this product term
            pub const PT3_AC_1: u16 = 0b01;

            /// 0b10: Complement the A input in this product term
            pub const PT3_AC_2: u16 = 0b10;

            /// 0b11: Force the A input in this product term to a logical one
            pub const PT3_AC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT2_DC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the D input in this product term to a logical zero
            pub const PT2_DC_0: u16 = 0b00;

            /// 0b01: Pass the D input in this product term
            pub const PT2_DC_1: u16 = 0b01;

            /// 0b10: Complement the D input in this product term
            pub const PT2_DC_2: u16 = 0b10;

            /// 0b11: Force the D input in this product term to a logical one
            pub const PT2_DC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT2_CC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the C input in this product term to a logical zero
            pub const PT2_CC_0: u16 = 0b00;

            /// 0b01: Pass the C input in this product term
            pub const PT2_CC_1: u16 = 0b01;

            /// 0b10: Complement the C input in this product term
            pub const PT2_CC_2: u16 = 0b10;

            /// 0b11: Force the C input in this product term to a logical one
            pub const PT2_CC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT2_BC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the B input in this product term to a logical zero
            pub const PT2_BC_0: u16 = 0b00;

            /// 0b01: Pass the B input in this product term
            pub const PT2_BC_1: u16 = 0b01;

            /// 0b10: Complement the B input in this product term
            pub const PT2_BC_2: u16 = 0b10;

            /// 0b11: Force the B input in this product term to a logical one
            pub const PT2_BC_3: u16 = 0b11;
        }
    }
    ...
    pub mod PT2_AC {
        ...
        pub mod RW {
            ...
            /// 0b00: Force the A input in this product term to a logical zero
            pub const PT2_AC_0: u16 = 0b00;

            /// 0b01: Pass the A input in this product term
            pub const PT2_AC_1: u16 = 0b01;

            /// 0b10: Complement the A input in this product term
            pub const PT2_AC_2: u16 = 0b10;

            /// 0b11: Force the A input in this product term to a logical one
            pub const PT2_AC_3: u16 = 0b11;
        }
    }
}
